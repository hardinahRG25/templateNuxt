		...
		<div class="fancy-portfolio-six mt-80 md-mt-40" id="portfolio01">
			<div class="container">
				<div class="bottom-border pb-130 md-pb-50">
					<div
						class="controls po-control-two text-center mb-90 md-mb-50"
					>
						<button
							type="button"
							:class="`control ${
					...
					<div class="text-center mt-80 md-mt-60">
						...
						>
							<img src="/images/icon/156.png" alt=""
						/></a>
					</div>
				</div>
			</div>
