			...
			<div class="row justify-content-center">
				<div class="col-md-4 col-sm-6">
					<div class="address-info">
						<div class="icon">
							<nuxt-img src="/images/icon/15.svg" alt="" />
						</div>
						<div class="title">Location</div>
						<p class="font-rubik">
							Dhaka, Kawran Bazar <br />
							1201 Metro
						</p>
					</div>
					<!-- /.address-info -->
				...
				<div class="col-md-4 col-sm-6">
					<div class="address-info">
						<div class="icon">
							<nuxt-img src="/images/icon/16.svg" alt="" />
						</div>
						<div class="title">Contact</div>
						<p class="font-rubik">
							bawejkor@duwvude.gov <br />(779) 564-1593
						</p>
					</div>
					<!-- /.address-info -->
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="address-info">
						<div class="icon">
							<nuxt-img src="/images/icon/17.svg" alt="" />
						</div>
