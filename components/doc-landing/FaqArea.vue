<template>
	<div class="faq-classic with-bg">
		<nuxt-img src="/images/shape/86.svg" alt="" class="shapes shape-one" />
		<nuxt-img src="/images/shape/87.svg" alt="" class="shapes shape-two" />
		<nuxt-img
			src="/images/shape/88.svg"
			alt=""
			class="shapes shape-three"
		/>
		<nuxt-img src="/images/shape/89.svg" alt="" class="shapes shape-four" />
		<nuxt-img src="/images/shape/90.svg" alt="" class="shapes shape-five" />
		<nuxt-img src="/images/shape/91.svg" alt="" class="shapes shape-six" />
		<div class="container">
