				...
				<div class="row">
					<div class="col-xl-11 m-auto">
						<div class="header text-center">
							...
							<ul
								class="d-flex justify-content-center social-icon mt-35"
							>
								<li>
									<a href="#"
										><i
						...
						<div class="col-xl-11 m-auto">
							<div class="row">
								...
								<div class="col-md-8 order-md-first">
									<h4>Overviw</h4>
									<p>
										Commonly used in the graphic, prit quis
										due & publishing indust for previewing
										lightly visual mockups.
									</p>
									<h4>Task</h4>
									<p>
										Rebuild a unified visual system for the
										advertising agency, made of steel which
										can change theworld in a while.
									</p>
									<a href="#" class="theme-btn-eight"
										>Check Live Link</a
									>
								</div>
							</div>
							<div class="top-border mt-70 pt-50 md-mt-40">
								<ul
									class="portfolio-pagination d-flex justify-content-between"
								>
									<li>
										<a
											href="#"
										...
										>
											...
											/>
											<span
												class="d-inline-block ps-lg-4"
											>
												<span class="tp1 d-block"
													>Previous</span
												>
												<span class="tp2 d-block"
									...
									<li>
										...
										>
											...
											/>
											<span
												class="d-inline-block pe-lg-4"
											>
												<span class="tp1 d-block"
													>Next</span
												>
												<span class="tp2 d-block"
													>Uber App Design</span
												>
											</span>
										</a>
									</li>
